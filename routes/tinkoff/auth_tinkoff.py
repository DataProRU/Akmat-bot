...
from services.driver_setup import create_chrome_driver, close_driver, is_browser_active, reset_interaction_time
from services.tinkoff_auth import paged_login, close_login_via_sms_page, get_user_name_from_otp_login
from services.browser_utils import get_text, detect_page_type, PageType, click_button
...
async def next_page(request: Request, step: Union[str, None] = Query(default=None)):
